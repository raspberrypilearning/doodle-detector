...
Çizdiklerinizi tanıyabilmesi için bir makine öğrenme modeli eğitin.

![Birinin elma çizdiği ve Scratch kedisinin "Tahminime göre bu bir...elma" dediği bir Scratch projesi](images/its-an-apple.png)

--- collapse ---

---

## Resimlerim nerede saklanıyor?
...
[Bu proje için tüm videoları](https://rpf.io/p/tr-TR/doodle-detector-go){:target="_blank"} indirebilirsiniz.
